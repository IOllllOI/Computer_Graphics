...
palette = Frame(lf_tools_panel)
palette.pack(side = LEFT)
p_lvl1 = Frame(palette)
p_lvl1.pack(side = TOP)
p_lvl2 = Frame(palette)
p_lvl2.pack(side = TOP)
p_lvl2 = Frame(palette)
p_lvl2.pack(side = TOP)
...
# b_color = Button(lf_tools_panel, text = 'color', command = )
# b_color.pack(side = LEFT)
